...
//
// Copia del módulo del backend de users, igual que `auth.js` o `rate_limit.js`:
// los tres backends repiten estos archivos en vez de compartir un paquete.
// El aliado verifica su teléfono con el mismo criterio que un cliente.
//
