...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _valores = {
    'es': {
      ...
      // En plural: son los de la cédula, y una cédula trae varios.
      'first_name': 'Nombres',
      'last_name': 'Apellidos',
      ...
      'verified_data_note':
          'Estos datos salen de tu identidad. Solo estos no se pueden modificar.',
      'email': 'Correo electrónico',
      'contact_data': 'Contacto',
      'contact_data_note':
          'Los usamos para contactarte. No aparecen en tu perfil público.',
      'phone': 'Teléfono',
      ...
      'business_profile': 'Mi perfil de aliado',
      'business_profile_hint': 'Cómo te ven los usuarios',
      'no_contact_note':
          'No escribas teléfonos, direcciones, correos ni enlaces. Cada cambio de tu perfil pasa por revisión y se rechaza si los trae.',
      'no_contact_error':
          'Quita el teléfono, la dirección o el enlace: no se permiten acá',
      'words_label': 'palabras',
      'profile_change_sent': 'Enviamos tu cambio a revisión',
      'profile_change_pending_title': 'Tu cambio está en revisión',
      'profile_change_pending_body':
          'Mientras respondemos, los usuarios siguen viendo tu perfil anterior. No puedes editarlo hasta que terminemos.',
      'profile_change_approved': 'Tu cambio de perfil fue aprobado',
      'profile_change_rejected': 'Tu cambio de perfil no fue aprobado',
    ...
    'en': {
      ...
      'verified_data_note':
          'These come from your identity. Only these cannot be changed.',
      'email': 'Email',
      'contact_data': 'Contact',
      'contact_data_note':
          'We use them to reach you. They do not show on your public profile.',
      'phone': 'Phone',
      'phone_too_short': 'The phone number is too short',
      ...
      'business_profile': 'My ally profile',
      'business_profile_hint': 'How users see you',
      'no_contact_note':
          'Do not write phone numbers, addresses, emails or links. Every change to your profile is reviewed and rejected if it has any.',
      'no_contact_error':
          'Remove the phone number, address or link: they are not allowed here',
      'words_label': 'words',
      'profile_change_sent': 'We sent your change for review',
      'profile_change_pending_title': 'Your change is under review',
      'profile_change_pending_body':
          'While we answer, users still see your previous profile. You cannot edit it until we are done.',
      'profile_change_approved': 'Your profile change was approved',
      'profile_change_rejected': 'Your profile change was not approved',
