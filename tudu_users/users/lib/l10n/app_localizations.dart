...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'es': {
      ...
      'user': 'Usuario',
      'photo_approved_title': '¡Foto Aprobada!',
      'photo_rejected_title': 'Foto Rechazada',
      'photo_approved_desc': 'Tu nueva foto de perfil ha sido aprobada y ya está visible para todos.',
      'understood': 'Entendido',
      'reason_sexual': 'Contenido inapropiado o explícito',
      'reason_offensive': 'Contenido ofensivo o violento',
      'reason_fake': 'Impersonación o identidad falsa',
      'reason_quality': 'Mala calidad o irreconocible',
      'reason_other': 'Incumplimiento de las políticas',
      'photo_rejected_prefix': 'Tu imagen fue rechazada por: ',
      'photo_rejected_suffix': '. Vuelve a intentarlo con otra imagen.',
    ...
    'en': {
      ...
      'photo_rejected_title': 'Photo Rejected',
      'photo_approved_desc': 'Your new profile photo has been approved and is now visible to everyone.',
      'understood': 'Understood',
      'reason_sexual': 'Inappropriate or explicit content',
      'reason_offensive': 'Offensive or violent content',
      'reason_fake': 'Impersonation or fake identity',
      'reason_quality': 'Poor quality or unrecognizable',
      'reason_other': 'Policy violation',
      'photo_rejected_prefix': 'Your image was rejected due to: ',
      'photo_rejected_suffix': '. Please try again with another image.',
  ...
  /// Métudu abreviado para traducir
